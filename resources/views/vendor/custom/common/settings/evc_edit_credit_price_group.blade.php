	...
	@section('header')
		<section class="content-header">
		  ...
		  <ol class="breadcrumb">
		    ...
		    <li><a href="{{ backpack_url('tuning-evc-credit') }}" class="text-capitalize">Tuning credit prices</a></li>
		    <li class="active">Edit</li>
		  </ol>
		</section>
	@endsection
	@section('content')
		<form method="post" action="{{ backpack_url('tuning-evc-credit/'.$entry->id) }}">
		  	@csrf
			@method('PUT')
			<div class="row">
				<div class="col-md-12">
