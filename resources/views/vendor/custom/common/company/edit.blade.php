...
<div class="row">
	<div class="col-md-12">
		...
		@include('crud::inc.grouped_errors')
		  ...
		  <form method="post"
		  		action="{{ backpack_url('company/'.$entry->id) }}?step=nameandaddress"
		  ...
		  <div class="box">
		    ...
		    <div class="box-body row display-flex-wrap" id="tabs_edit" style="display: flex;flex-wrap: wrap;">
...
$(document).ready(function(){
    ...
    var action = "{{ backpack_url('company')}}/"+id+"?step="+active_tab;
    $("#company-form").attr("action",action);
});

$("#tabs_edit li a").click(function(q){
